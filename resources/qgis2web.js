...
map.getView().fit([12546820.000144, -816639.536467, 12553930.090757, -811569.377115], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Titik Transportasi Umum di Kecamatan Wonokromo</h2>';
        return titleElement;
    })(),
